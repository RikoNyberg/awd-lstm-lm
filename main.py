...
class LanguageModelTrainer():
    ...
    def build_model(self):
        ...
        self.model = model.RNNModel(self.args.model, ntokens, self.args.emsize, self.args.nhid, self.args.nlayers, self.args.dropout, self.args.dropouth, self.args.dropouti, self.args.dropoute, self.args.wdrop, self.args.tied, self.args.word_embedding)
        ###
        if self.args.resume:
